...
export const Navigation: React.FC = () => {
  ...
  return (
    ...
    >
      <div className={`max-w-[100vw] rounded-full sm:rounded-full px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 flex items-center justify-between transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-md shadow-lg' : 'bg-[#fbf5ee]/90 backdrop-blur-sm'}`}>
